...
export const isIPValid = (ipAddress: string) => {
  ...
  // This is a basic pattern for IPv4 addresses, you may need to adjust it for IPv6 or more specific requirements
...
export const isIsraeliIDValid = (idNumber: string) => {
  ...
  // This pattern checks for 9 digits
  const idRegex = /^\d{9}$/;
...
export const isIsraeliPhoneNumberValid = (phoneNumber: string) => {
  ...
  // This pattern checks for a basic format, such as +972123456789 or 05-1234567
